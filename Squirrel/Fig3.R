...
resSum[resSum$strategy==7 & resSum$nGuides==0,]$gd.type <- "Cleave-and-rescue"
resSum$gd.type <- factor(resSum$gd.type, levels=c("Homing","Homing & Cleave-and-rescue","Cleave-and-rescue"))

# View(resSum)

# save(res, resSum, file = "Fig3.RData")
...
ggsave(plot = p + PaperTheme, filename = "Fig3.png",    height = PaperSize, width = PaperSize * 2, unit = "cm")
ggsave(plot = p + PreseTheme, filename = "Fig3_PPT.png", height = PreseSize, width = PreseSize * 2, unit = "cm")
