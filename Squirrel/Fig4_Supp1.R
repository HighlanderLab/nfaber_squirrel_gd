...
# save(res, resSum, file = 'Fig4_Supp1.RData')
# load(file = 'Fig4_Supp1.RData')
...
ggsave(plot = p + PaperTheme, filename = "Fig4_Supp1.png",    height = PaperSize*0.85, width = PaperSize*2, unit = "cm")
ggsave(plot = p + PreseTheme, filename = "Fig4_Supp1_PPT.png", height = PreseSize*0.85, width = PreseSize*2, unit = "cm")
