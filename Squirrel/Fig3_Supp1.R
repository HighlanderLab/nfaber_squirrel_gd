...
source(file = '../gene_drive_squirrel.R')
...
resSum$gd.type <- NA
resSum[resSum$strategy==4,]$gd.type <- "Homing"
resSum[resSum$strategy==7,]$gd.type <- "Homing & Cleave-and-rescue"
resSum[resSum$strategy==7 & as.integer(levels(resSum$nGuides)[resSum$nGuides])==0,]$gd.type <- "Cleave-and-rescue"
resSum$gd.type <- factor(resSum$gd.type, levels=c("Homing","Homing & Cleave-and-rescue","Cleave-and-rescue"))

# View(resSum)

# save(res, resSum, file = "Fig3_Supp1.RData")
# load(file = "Fig3_Supp1.RData")
...
ggsave(plot = p + PaperTheme, filename = "Fig3_Supp1.png",    height = PaperSize, width = PaperSize * 2, unit = "cm")
ggsave(plot = p + PreseTheme, filename = "Fig3_Supp1_PPT.png", height = PreseSize, width = PreseSize * 2, unit = "cm")
