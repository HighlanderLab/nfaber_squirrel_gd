...
# save(res, resSum, file = 'final/Fig5.RData')
# load(file = 'final/Fig5.RData')
...
ggsave(plot = p + PaperTheme, filename = "Fig5.png",    height = PaperSize, width = PaperSize*2.5, unit = "cm")
ggsave(plot = p + PreseTheme, filename = "Fig5_PPT.png", height = PreseSize, width = PreseSize*2.5, unit = "cm")
