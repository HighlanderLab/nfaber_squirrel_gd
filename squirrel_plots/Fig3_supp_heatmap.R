...
# save(res, resSum, file = 'Fig3_supp_heatmap.RData')
# load(file = 'Fig3_supp_heatmap.RData')
...
ggsave(plot = p + PaperTheme, filename = "Fig3_supp_heatmap_50yrs.png",    height = PaperSize, width = PaperSize * 1.5, unit = "cm")
ggsave(plot = p + PreseTheme, filename = "Fig3_supp_heatmap_50yrs_PPT.png", height = PreseSize, width = PreseSize * 1.5, unit = "cm")
