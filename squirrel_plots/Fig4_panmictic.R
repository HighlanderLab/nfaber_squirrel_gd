...
# save(res, resSum, file = "Fig4_panmictic.RData")
# load(file = "Fig4_panmictic.RData")
...
resSum.panmictic$type <- "Panmictic"
...
ggsave(plot = p + PaperTheme, filename = "Fig4.png",    height = PaperSize, width = PaperSize * 1.5, unit = "cm")
ggsave(plot = p + PreseTheme, filename = "Fig4_PPT.png", height = PreseSize, width = PreseSize * 1.5, unit = "cm")
