...
# save(res, resSum, file = 'Fig5_Supp1.RData')
# load(file = 'Fig5_Supp1.RData')
...
ggsave(plot = p + PaperTheme, filename = "Fig5_Supp1.png",    height = PaperSize, width = PaperSize * 1.5, unit = "cm")
ggsave(plot = p + PreseTheme, filename = "Fig5_Supp1_PPT.png", height = PreseSize, width = PreseSize * 1.5, unit = "cm")
